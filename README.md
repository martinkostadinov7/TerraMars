...
- **Statistics Panel** – The left side of the interface displays live stats such as mined resources, energy use, and map data.  
- **Interactive Editing** – Modify and experiment with the landscape in real time.
...
2. **Create a Map**  
   Generate a new Martian terrain — each one is unique!  

3. **Explore and Modify**  
   Place drills, fire the laser, and transform the grid.  

4. **Monitor Progress**  
   View detailed statistics about the current tile.  
...
- Upgradable drill and laser tools  
- Mars colonization objectives
...
4. Login and start simulating Mars!
